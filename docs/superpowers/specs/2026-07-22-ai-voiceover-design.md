...
with a Microsoft David voiceover. The narration must explain what Cutscene is,
how Codex was used, and how GPT-5.6 was used. The finished video must remain
under three minutes.

## Design

- Preserve the existing MP4 and write `cutscene-demo-ai-voice.mp4`.
- Use Windows `System.Speech` with the installed Microsoft David voice. No API,
  network service, new dependency, or hosted credit is needed.
...
- Structure the narration around the visible demo: problem, semantic capture,
  generated kit, interactive guide, regeneration, Codex usage, GPT-5.6 usage,
  and closing distinction.

## Failure handling and verification

- Stop if Microsoft David is unavailable or speech synthesis fails.
